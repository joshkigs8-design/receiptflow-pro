...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      landlord_kcb_configs: {
        Row: {
          account_number: string | null;
          account_reference_prefix: string | null;
          client_key: string;
          client_secret: string;
          connection_status: "untested" | "connected" | "failed" | null;
          created_at: string;
          environment: "sandbox" | "production";
          id: string;
      ...
      kcb_transactions: {
        Row: {
          ...
          result_desc: string | null;
          status: "initiated" | "pending" | "success" | "failed" | "cancelled" | "pending_reconciliation";
          tenant_id: string | null;
          unit_id: string | null;
          updated_at: string;
        };
