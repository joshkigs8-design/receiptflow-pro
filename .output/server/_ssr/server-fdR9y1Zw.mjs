...
//#region node_modules/.nitro/vite/services/ssr/assets/server-fdR9y1Zw.js
var server_fdR9y1Zw_exports = /* @__PURE__ */ __exportAll({
	a: () => getRequest,
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CuHOR5Vp.mjs");
...
var manifest = {
	...
	"34b2823a7788c6e0663cd40d132c5925e890896eda041c87f8bae710cfb0f66d": {
		...
		importer: () => import("./portal.functions-gq2joKPR.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-8Z92OHgn.mjs").then((n) => n.o).then((n) => n.t),
...
//#endregion
export { server_fdR9y1Zw_exports as a, getServerFnById as i, createServerFn as n, getRequest as r, TSS_SERVER_FUNCTION as t };
