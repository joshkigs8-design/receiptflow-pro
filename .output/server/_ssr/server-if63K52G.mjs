...
//#region node_modules/.nitro/vite/services/ssr/assets/server-if63K52G.js
var server_if63K52G_exports = /* @__PURE__ */ __exportAll({
	a: () => getRequest,
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CFHAsqh6.mjs");
...
var manifest = {
	...
	"15b806b7cf6f4bcf86632629ead957c274b475e57ae2dddac283da9e97ff5ea5": {
		...
		importer: () => import("./app.functions-DH8csfkD.mjs")
	},
	...
	"34b2823a7788c6e0663cd40d132c5925e890896eda041c87f8bae710cfb0f66d": {
		...
		importer: () => import("./portal.functions-DfR8h3HZ.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-49H3NiY0.mjs").then((n) => n.a).then((n) => n.t),
...
//#endregion
export { server_if63K52G_exports as a, getServerFnById as i, createServerFn as n, getRequest as r, TSS_SERVER_FUNCTION as t };
