...
//#region node_modules/.nitro/vite/services/ssr/assets/SiteFooter-B0wDVFhX.js
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							children: ["Rent Receipt ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
function SiteFooter() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("footer", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mx-auto grid max-w-7xl gap-10 px-6 py-14 sm:grid-cols-2 lg:grid-cols-4",
			children: [
