...
import { a as ThemeToggle, i as Route$3 } from "./router-CasRv2yH.mjs";
import { t as Button } from "./button-DRsC1qZi.mjs";
import { t as Label } from "./label-B4PTMSG2.mjs";
import { t as Input } from "./input-DicJzR9-.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/affiliate.auth-B5nVHO22.js
	...
	async function onSubmit(e) {
		...
		try {
			if (signup) {
				...
				if (referralCode) try {
					const { recordReferral } = await import("./affiliate.functions-kXxxGJ1i.mjs");
