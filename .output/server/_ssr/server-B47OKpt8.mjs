...
//#region node_modules/.nitro/vite/services/ssr/assets/server-B47OKpt8.js
var server_B47OKpt8_exports = /* @__PURE__ */ __exportAll({
	a: () => getRequest,
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C7AzjoeI.mjs");
...
var manifest = {
	...
	"34b2823a7788c6e0663cd40d132c5925e890896eda041c87f8bae710cfb0f66d": {
		...
		importer: () => import("./portal.functions-CXN2gT4v.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-g2Ac5Zqz.mjs").then((n) => n.a).then((n) => n.t),
...
//#endregion
export { server_B47OKpt8_exports as a, getServerFnById as i, createServerFn as n, getRequest as r, TSS_SERVER_FUNCTION as t };
